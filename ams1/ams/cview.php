...
$sql1 = "select * from 20is520_cie";
$res1 = mysqli_query($conn,$sql1);
$sql = "SHOW COLUMNS FROM 20is520_cie";
...
<script type="text/javascript">
    ...
    <form class="" action="cexp.php" method="post">
      <center>
    ...
    <br>
    <br>
    <center> <h5>Export both Attendance and CIE details</h5>  </center>
    <br>
    <form class="" action="acexp.php" method="post">
      <center>
        <input type="submit" name="export" value="Export Full details" class="btn btn-secondary">
      </center>
    </form>
    <br>
  </body>
